        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                        .Annotation("SqlServer:IsTemporal", true)
                        .Annotation("SqlServer:TemporalHistoryTableName", "CastMembersHistory")
                        .Annotation("SqlServer:TemporalHistoryTableSchema", null)
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                        .Annotation("SqlServer:TemporalPeriodStartColumnName", "PeriodStart"),
                    ApplicationUserUpdatedById = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                    ...
                    Name1 = table.Column<string>(type: "nvarchar(max)", nullable: false)
                        ...
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                        .Annotation("SqlServer:TemporalPeriodStartColumnName", "PeriodStart"),
                    NormalizedName1 = table.Column<string>(type: "nvarchar(max)", nullable: false)
                        .Annotation("SqlServer:IsTemporal", true)
                        .Annotation("SqlServer:TemporalHistoryTableName", "CastMembersHistory")
                        .Annotation("SqlServer:TemporalHistoryTableSchema", null)
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                    ...
                    Name2 = table.Column<string>(type: "nvarchar(max)", nullable: false)
                        ...
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                        .Annotation("SqlServer:TemporalPeriodStartColumnName", "PeriodStart"),
                    NormalizedName2 = table.Column<string>(type: "nvarchar(max)", nullable: false)
                        .Annotation("SqlServer:IsTemporal", true)
                        .Annotation("SqlServer:TemporalHistoryTableName", "CastMembersHistory")
                        .Annotation("SqlServer:TemporalHistoryTableSchema", null)
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CastMembers_AspNetUsers_ApplicationUserUpdatedById",
                        column: x => x.ApplicationUserUpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                        .Annotation("SqlServer:IsTemporal", true)
                        .Annotation("SqlServer:TemporalHistoryTableName", "MoviesHistory")
                        .Annotation("SqlServer:TemporalHistoryTableSchema", null)
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                        .Annotation("SqlServer:TemporalPeriodStartColumnName", "PeriodStart"),
                    ApplicationUserUpdatedById = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Movies_AspNetUsers_ApplicationUserUpdatedById",
                        column: x => x.ApplicationUserUpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "CastMemberMovies",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                        .Annotation("SqlServer:IsTemporal", true)
                        .Annotation("SqlServer:TemporalHistoryTableName", "CastMemberMoviesHistory")
                        .Annotation("SqlServer:TemporalHistoryTableSchema", null)
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                        .Annotation("SqlServer:TemporalPeriodStartColumnName", "PeriodStart"),
                    ApplicationUserUpdatedById = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                        ...
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                        .Annotation("SqlServer:TemporalPeriodStartColumnName", "PeriodStart"),
                    CastMemberId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                        .Annotation("SqlServer:IsTemporal", true)
                        .Annotation("SqlServer:TemporalHistoryTableName", "CastMemberMoviesHistory")
                        .Annotation("SqlServer:TemporalHistoryTableSchema", null)
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CastMemberMovies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CastMemberMovies_AspNetUsers_ApplicationUserUpdatedById",
                        column: x => x.ApplicationUserUpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CastMemberMovies_CastMembers_CastMemberId",
                        column: x => x.CastMemberId,
                        principalTable: "CastMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CastMemberMovies_Movies_MovieId",
                        column: x => x.MovieId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CastMemberMovies_ApplicationUserUpdatedById",
                table: "CastMemberMovies",
                column: "ApplicationUserUpdatedById");

            migrationBuilder.CreateIndex(
                name: "IX_CastMemberMovies_CastMemberId",
                table: "CastMemberMovies",
                column: "CastMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_CastMemberMovies_MovieId",
                table: "CastMemberMovies",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_CastMembers_ApplicationUserUpdatedById",
                table: "CastMembers",
                column: "ApplicationUserUpdatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Movies_ApplicationUserUpdatedById",
                table: "Movies",
                column: "ApplicationUserUpdatedById");
        }
